    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          {/* ── Sell Section ── */}
          <div className="mt-6 pt-6 border-t border-border">
            <ListForSaleSection module="guitars" itemId={item.id} condition={item.condition} initialIntro={item.listing_intro} initialFooter={item.listing_footer} onIntroSaved={(v) => onItemUpdated?.({ ...item, listing_intro: v })} onFooterSaved={(v) => onItemUpdated?.({ ...item, listing_footer: v })} />
          </div>
